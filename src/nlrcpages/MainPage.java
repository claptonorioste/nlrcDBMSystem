 			...
 			public void mouseClicked(MouseEvent e) {
 				...
 				if(!"".equals(tfCnum.getText())&&!"".equals(titleTF.getText()) && (!jValidateButton(rabDD,rabDM,rabDY)) && (!jValidateButton(dProM,dPromD,dPromY)) && 
		 				...
		 				if(edit == 0) {
		 					...
		 					String appealed2 = comboBox_9 .getSelectedItem().toString()+"-"+comboBox_7.getSelectedIndex() + "-" + comboBox_6 .getSelectedItem().toString();
		 					String received2 = comboBox_13 .getSelectedItem().toString()+"-"+comboBox_10.getSelectedIndex() + "-" + comboBox_11 .getSelectedItem().toString();
			 				...
			 				DBQuery.insertCase(tfCnum.getText(),titleTF.getText()+" vs "+respon.getText() ,dateNLRC,dateOECC, dateComm, dateApp,dateMR,dateMRpro 
			 						...
			 						decisionMR1.getText(),dtmR2,mrFiled2.getText(),decisionMR2.getText(),comboBox_4.getSelectedItem().toString(),appealed2,received2);
		 					...
		 					int input = JOptionPane.showConfirmDialog(null, "Save Changes?","Confirm",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
		 					 if(input==0) {
		 						 DBQuery.updateCase(tfCnum.getText(),titleTF.getText()+" vs "+respon.getText() ,dateNLRC,dateOECC,
		 								 ...
		 								 taDecisiononApp.getText(),mrFiled1.getText(),decisionMR1.getText(),dtmR2,mrFiled2.getText(),decisionMR2.getText(),comboBox_4.getSelectedItem().toString(),appealed2,received2);
...
DefaultTableModel tm = (DefaultTableModel) DbUtils.resultSetToTableModel(DBQuery.queryCaseTitle());
 		...
 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		comboBox.setBounds(21, 11, 67, 20);
	 		...
	 		tfCnum.setBounds(584, 11, 267, 20);
	 		
	 		tfCnum.setColumns(10);
	 		
	 		JLabel label_20 = new JLabel("Case Title:");
	 		label_20.setBounds(31, 38, 82, 20);
			...
			@Override protected void paintComponent(Graphics g) {
	 		...
	 		textField_9.setBounds(89, 11, 315, 20);
	 		...
	 		titleTF.setBounds(21, 60, 475, 20);
	 		titleTF.setColumns(10);
	 		
	 		rab_num = new JComboBox();
	 		rab_num.setBounds(508, 11, 75, 20);
	 		rab_num.addItem("RAB");
	 		rab_num.addItem("SRAB");
	 		
	 		OECCMonth = new JComboBox();
	 		OECCMonth.setBounds(516, 194, 60, 20);
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 		...
	 		OECCDay.setBounds(586, 194, 60, 20);
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		OECCYear.setBounds(656, 194, 99, 20);
	 		yearIndex = 0;
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		induCode.setBounds(22, 194, 179, 20);
	 		...
	 		natureOfC.setBounds(22, 241, 179, 20);
	 		...
	 		natureofA.setBounds(22, 292, 352, 20);
	 		natureofA.setColumns(10);
	 		
	 		ammCurrency = new JComboBox();
	 		ammCurrency.setBounds(22, 345, 75, 20);
	 		ammCurrency.addItem("--");
	 		...
	 		ammOfAward.setBounds(98, 345, 156, 20);
			...
			@Override protected void paintComponent(Graphics g) {
	 		...
	 		textField_8.setBounds(270, 665, 49, 20);
	 		...
	 		LA.setBounds(91, 665, 169, 20);
	 		LA.setColumns(10);
	 		
	 		comboBox_6 = new JComboBox();
	 		comboBox_6.setBounds(103, 801, 75, 20);
	 		comboBox_6.addItem("--");
	 		for(int x = 0;x<currency.length;x++) {
	 		...
	 		appealFee.setBounds(184, 801, 125, 20);
	 		...
	 		bondFee.setBounds(103, 935, 238, 20);
	 		...
	 		bondDate.setBounds(103, 997, 238, 20);
	 		...
	 		courierAir.setBounds(516, 1044, 239, 22);
	 		courierAir.setColumns(10);
	 		
	 		ofw = new JComboBox();
	 		ofw.setBounds(405, 11, 65, 20);
	 		ofw.addItem("--");
	 		ofw.addItem("OFW (L)");
	 		ofw.addItem("OFW");
	 		...
	 		nlrcM = new JComboBox();
	 		nlrcM.setBounds(516, 142, 60, 20);
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 			nlrcM.addItem(monthList[month]);
	 		}
	 		
	 		nlrcD = new JComboBox();
	 		nlrcD.setBounds(587, 142, 60, 20);
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 			nlrcD.addItem(String.valueOf(day));
	 		}
	 		
	 		nlrcY = new JComboBox();
	 		nlrcY.setBounds(657, 142, 99, 20);
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		dPromY.setBounds(162, 464, 99, 20);
	 		dPromY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		lblDatePromulgated.setBounds(32, 437, 137, 20);
			...
			@Override protected void paintComponent(Graphics g) {
	 		...
	 		textField_7.setBounds(329, 665, 49, 20);
	 		textField_7.setColumns(10);
	 		
	 		dMailM = new JComboBox();
	 		dMailM.setBounds(22, 532, 60, 20);
	 		dMailM.addItem("--");
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 		...
	 		dMailY.setBounds(162, 532, 99, 20);
	 		dMailY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		dAppealRD.setBounds(92, 598, 60, 20);
	 		dAppealRD.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		dAppealRY.setBounds(162, 598, 99, 20);
	 		dAppealRY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		appealOr.setBounds(103, 832, 238, 20);
	 		appealOr.setColumns(10);
	 		
	 		appealfeeM = new JComboBox();
	 		appealfeeM.setBounds(103, 863, 60, 20);
	 		appealfeeM.addItem("--");
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 		...
	 		appealfeeD.setBounds(173, 863, 60, 20);
	 		appealfeeD.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		appealfeeY.setBounds(242, 863, 99, 20);
	 		appealfeeY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		label_71.setBounds(31, 904, 97, 20);
	 		...
	 		BondAmount.setBounds(182, 966, 159, 20);
	 		...
	 		bondDD.setBounds(173, 1024, 60, 20);
	 		bondDD.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		bondDM.setBounds(103, 1024, 60, 20);
	 		bondDM.addItem("--");
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 		...
	 		bondDY.setBounds(242, 1024, 99, 20);
	 		bondDY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		textField_11.setBounds(102, 1055, 239, 20);
	 		...
	 		textField_12.setBounds(103, 1086, 238, 20);
	 		textField_12.setColumns(10);
	 		
	 		bndm = new JComboBox();
	 		bndm.setBounds(103, 1114, 60, 20);
	 		bndm.addItem("--");
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 		...
	 		ponenteDD.setBounds(586, 292, 60, 20);
	 		ponenteDD.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		dateAppPoneneteD.setBounds(587, 345, 60, 20);
	 		...
	 		dateAppPoneneteY.setBounds(657, 345, 99, 20);
	 		...
	 		dateMRD1.setBounds(586, 483, 60, 20);
	 		dateMRD1.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		dateMRY1.setBounds(656, 483, 99, 20);
	 		dateMRY1.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		ponenteDY.setBounds(656, 292, 99, 20);
	 		ponenteDY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		label_25.setBounds(537, 511, 109, 20);
	 		...
	 		dateMRD2.setBounds(588, 683, 60, 20);
	 		dateMRD2.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		dateMRY2.setBounds(658, 683, 99, 20);
	 		dateMRY2.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		entryJD.setBounds(586, 871, 60, 20);
	 		entryJD.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 		...
	 		entryJY.setBounds(656, 871, 99, 20);
	 		entryJY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		dEntryJID.addActionListener(new ActionListener() {
	 	 	...
	 	 	dEntryJIM.setBounds(516, 924, 60, 20);
	 	 	dEntryJIM.addItem("--");
	 	 	for(int month = 0 ; month <= 11 ; month++ ) {
	 		...
	 		dEntryJIY.setBounds(656, 924, 99, 20);
	 		dEntryJIY.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 		...
	 		dateRemandedD.setBounds(586, 975, 60, 20);
	 		...
	 		dateRemandedY.setBounds(656, 975, 99, 20);
	 		...
	 		scrollPane_9.setBounds(508, 395, 364, 62);
	 		...
	 		scrollPane_10.setBounds(508, 584, 364, 62);
	 		...
	 		scrollPane_11.setBounds(517, 779, 364, 62);
	 		...
	 		scrollPane_12.setBounds(516, 1094, 365, 123);
	 		...
	 		label_56.setBounds(265, 395, 82, 20);
	 		...
	 		label_57.setBounds(265, 464, 82, 20);
	 		...
	 		label_67.setBounds(265, 598, 82, 20);
	 		...
	 		label_66.setBounds(265, 532, 82, 20);
	 		...
	 		label_68.setBounds(351, 863, 82, 20);
	 		...
	 		label_69.setBounds(351, 1023, 82, 20);
	 		...
	 		label_70.setBounds(351, 1113, 82, 20);
	 		...
	 		label_73.setBounds(765, 292, 82, 20);
	 		...
	 		label_74.setBounds(772, 345, 82, 20);
	 		...
	 		label_75.setBounds(765, 483, 82, 20);
	 		...
	 		label_76.setBounds(767, 683, 82, 20);
	 		...
	 		label_77.setBounds(765, 870, 82, 20);
	 		...
	 		label_78.setBounds(765, 924, 82, 20);
	 		...
	 		label_79.setBounds(765, 975, 82, 20);
	 		...
	 		comboBox_4.setBounds(103, 967, 73, 20);
	 		comboBox_4.addItem("--");
	 		for(int x = 0;x<currency.length;x++) {
	 		...
	 		panel_21.add(ofw);
	 		panel_21.add(rab_num);
	 		panel_21.add(tfCnum);
	 		panel_21.add(label_20);
	 		panel_21.add(titleTF);
	 		panel_21.add(label_61);
	 		panel_21.add(respon);
	 		panel_21.add(label_21);
	 		panel_21.add(label_22);
	 		panel_21.add(label_31);
	 		panel_21.add(label_19);
	 		panel_21.add(appelant);
	 		panel_21.add(nlrcM);
	 		panel_21.add(nlrcD);
	 		panel_21.add(nlrcY);
	 		panel_21.add(label_27);
	 		panel_21.add(label_83);
	 		panel_21.add(induCode);
	 		panel_21.add(OECCMonth);
	 		panel_21.add(OECCDay);
	 		panel_21.add(OECCYear);
	 		panel_21.add(label_29);
	 		panel_21.add(natureOfC);
	 		panel_21.add(label_88);
	 		panel_21.add(tfPonente);
	 		panel_21.add(label_33);
	 		panel_21.add(label_89);
	 		panel_21.add(natureofA);
	 		panel_21.add(ponenteDM);
	 		panel_21.add(ponenteDD);
	 		panel_21.add(ponenteDY);
	 		panel_21.add(label_73);
	 		panel_21.add(label_18);
	 		panel_21.add(label_23);
	 		panel_21.add(ammCurrency);
	 		panel_21.add(ammOfAward);
	 		panel_21.add(dateAppPonenteM);
	 		panel_21.add(dateAppPoneneteD);
	 		panel_21.add(dateAppPoneneteY);
	 		panel_21.add(label_74);
	 		panel_21.add(label_24);
	 		panel_21.add(label_95);
	 		panel_21.add(rabDM);
	 		panel_21.add(rabDD);
	 		panel_21.add(rabDY);
	 		panel_21.add(lblDatePromulgated);
	 		...
	 		panel_21.add(label_96);
	 		panel_21.add(dateMRM1);
	 		panel_21.add(dateMRD1);
	 		panel_21.add(dateMRY1);
	 		panel_21.add(label_75);
	 		panel_21.add(label_53);
	 		panel_21.add(label_25);
	 		panel_21.add(dMailM);
	 		panel_21.add(dMailD);
	 		panel_21.add(dMailY);
	 		panel_21.add(label_66);
	 		panel_21.add(mrFiled1);
	 		panel_21.add(label_58);
	 		panel_21.add(dAppealRM);
	 		panel_21.add(dAppealRD);
	 		panel_21.add(dAppealRY);
	 		panel_21.add(label_67);
	 		panel_21.add(label_59);
	 		panel_21.add(label_60);
	 		panel_21.add(comboBox_5);
	 		panel_21.add(LA);
	 		panel_21.add(textField_8);
	 		panel_21.add(textField_7);
	 		panel_21.add(scrollPane_8);
	 		panel_21.add(label_62);
	 		panel_21.add(scrollPane_10);
	 		panel_21.add(label_63);
	 		panel_21.add(dateMRM2);
	 		panel_21.add(dateMRD2);
	 		panel_21.add(dateMRY2);
	 		panel_21.add(label_76);
	 		panel_21.add(label_84);
	 		panel_21.add(mrFiled2);
	 		panel_21.add(label_65);
	 		panel_21.add(label_64);
	 		panel_21.add(label_28);
	 		panel_21.add(comboBox_6);
	 		panel_21.add(appealFee);
	 		panel_21.add(label_30);
	 		panel_21.add(appealOr);
	 		panel_21.add(label_32);
	 		panel_21.add(appealfeeM);
	 		panel_21.add(appealfeeD);
	 		panel_21.add(appealfeeY);
	 		panel_21.add(label_68);
	 		panel_21.add(scrollPane_11);
	 		panel_21.add(label_86);
	 		panel_21.add(entryJM);
	 		panel_21.add(entryJD);
	 		panel_21.add(entryJY);
	 		panel_21.add(label_77);
	 		panel_21.add(label_71);
	 		panel_21.add(label_87);
	 		panel_21.add(label_38);
	 		panel_21.add(bondFee);
	 		panel_21.add(dEntryJIM);
	 		panel_21.add(dEntryJID);
	 		panel_21.add(dEntryJIY);
	 		panel_21.add(label_78);
	 		panel_21.add(label_41);
	 		panel_21.add(comboBox_4);
	 		panel_21.add(BondAmount);
	 		panel_21.add(label_90);
	 		panel_21.add(dateRemandedM);
	 		panel_21.add(dateRemandedD);
	 		panel_21.add(dateRemandedY);
	 		panel_21.add(label_79);
	 		panel_21.add(label_43);
	 		panel_21.add(bondDate);
	 		...
	 		panel_21.add(label_69);
	 		panel_21.add(label_91);
	 		panel_21.add(courierAir);
	 		...
	 		panel_21.add(bndd);
	 		panel_21.add(bndy);
	 		panel_21.add(label_70);
	 		panel_21.add(label_92);
	 		...
	 		comboBox_7.addItem("--");
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 			comboBox_7.addItem(monthList[month]);
	 		}
	 		comboBox_7.setBounds(787, 142, 60, 20);
	 		panel_21.add(comboBox_7);
	 		
	 		comboBox_8 = new JComboBox();
	 		comboBox_8.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 			comboBox_8.addItem(String.valueOf(day));
	 		}
	 		comboBox_8.setBounds(858, 142, 60, 20);
	 		panel_21.add(comboBox_8);
	 		
	 		comboBox_9 = new JComboBox();
	 		comboBox_9.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 			comboBox_9.addItem(String.valueOf(year));
	 		}
	 		comboBox_9.setBounds(928, 142, 99, 20);
	 		panel_21.add(comboBox_9);
	 		
	 		comboBox_10 = new JComboBox();
	 		comboBox_10.addItem("--");
	 		for(int month = 0 ; month <= 11 ; month++ ) {
	 			comboBox_10.addItem(monthList[month]);
	 		}
	 		
	 		comboBox_10.setSelectedIndex(1);
	 		comboBox_10.setBounds(787, 194, 60, 20);
	 		panel_21.add(comboBox_10);
	 		
	 		comboBox_11 = new JComboBox();
	 		comboBox_11.addItem("--");
	 		for(int day = 1 ; day <= 31 ; day++ ) {
	 			comboBox_11.addItem(String.valueOf(day));
	 		}
	 		comboBox_11.setBounds(857, 194, 60, 20);
	 		panel_21.add(comboBox_11);
	 		
	 		comboBox_13 = new JComboBox();
	 		comboBox_13.addItem("----");
	 		for(int year = 1978 ; year <= year_now  ; year++ ) {
	 			comboBox_13.addItem(String.valueOf(year));
	 		}
	 		comboBox_13.setBounds(927, 194, 99, 20);
	 		panel_21.add(comboBox_13);
	 		
	 		JLabel label_15 = new JLabel("Date Appealed to NLRC:");
	 		label_15.setForeground(Color.WHITE);
	 		label_15.setFont(new Font("Arial", Font.BOLD, 12));
	 		label_15.setBounds(800, 125, 137, 14);
	 		panel_21.add(label_15);
	 		
	 		JLabel label_46 = new JLabel("Date Received by OECC:");
	 		label_46.setForeground(Color.WHITE);
	 		label_46.setFont(new Font("Arial", Font.BOLD, 12));
	 		label_46.setBounds(800, 177, 137, 14);
	 		panel_21.add(label_46);
...
//					int f_year = cal9.get(Calendar.YEAR);
				...
				txtPane.setText("<html><head>"
						...
						+ "</head><body style='text-align:center;'>"
				 		...
				 		+ "</tr>"
				 		+ "<tr>"
				 		+ "<td colspan='2'>"+rs.getString("appealed2")+"</td>"
				 		+ "<td> </td>"
				 		+ "<td colspan='2'>"+rs.getString("received2")+"</td>"
				 		+ "</tr>"
				 		+ "<tr>"
